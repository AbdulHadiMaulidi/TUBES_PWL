    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 py-5 lg:max-w-7xl">
                @if (Route::has('login'))
                            <nav class="-mx-5 flex flex-1 justify-end">
                                ...
                                <a
                                        href="{{ route('login') }}"
                                        class="rounded-full px-4 py-2 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 shadow-lg hover:shadow-xl transition hover:from-blue-400 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-300"
                                    >
                                        Log in
                                    </a>
                                    ...
                                    <a
                                            href="{{ route('register') }}"
                                            class="ml-4 rounded-full px-4 py-2 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 shadow-lg hover:shadow-xl transition hover:from-blue-400 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-300"
                                        >
                                            Register
                                        </a>
                                    @endif
                    ...
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        ...
                        <img src="{{ asset('images/inventory.png') }}" alt="Logo" class="h-12 w-auto lg:h-16" style="width: 8cm; height: 8cm;">
                        </div>
                    </header>

                    <!-- <main>
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            <div class="flex flex-col items-center  gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] 
                            ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none
                    ...
                    <footer class="py-20 text-center text-xl text-black dark:text-white/70">
